...
const Home = () => {
  ...
  const [ setSubmitStatus] = useState(null); // 'success' or 'error'
  ...
  const handleSubmit = (e) => {
    ...
    // Mocking a successful submission for demonstration purposes
    const isSuccessful = true; // Change this to `false` to simulate an error

    if (isSuccessful) {
      setSubmitStatus("success");
      alert("Terima kasih atas feedback Anda!"); // Success alert
      setFeedback({ email: "", message: "" }); // Clear the form
    } else {
      setSubmitStatus("error");
      alert("Terjadi kesalahan, silakan coba lagi."); // Error alert
    }
  };
